...
# feito todos os casos 
# LEMBRAR DE ALTERAR O UTIL (CARACTERES ESPECIAIS)
...
executar('experimento1/','sce/unbalanced/colecao_dourada_2_class_unbalanced.csv',False)
executar('experimento1/','sce/unbalanced/colecao_dourada_3_class_unbalanced.csv',False)
executar('experimento1/','sce/balanced/colecao_dourada_2_class_balanced.csv',False)
executar('experimento1/','sce/balanced/colecao_dourada_3_class_balanced.csv',False)
executar('experimento2/','sce/unbalanced/colecao_dourada_2_class_unbalanced.csv',True)
executar('experimento2/','sce/unbalanced/colecao_dourada_3_class_unbalanced.csv',True)
executar('experimento2/','sce/balanced/colecao_dourada_2_class_balanced.csv',True)
executar('experimento2/','sce/balanced/colecao_dourada_3_class_balanced.csv',True)