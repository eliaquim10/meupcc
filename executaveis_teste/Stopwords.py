...
def executar(experimento,nome_Base,acento):
    ...
    while (k<l):
        ...
        n=0
        while(n<m):
            if documents[k][0][n] not in all_words:
    ...
    documents = [[removerpalavras(all_words.keys(),w[0]),w[1]] for w in documents]
...
executar('experimento/e3/','experimento/sce/unbalanced/colecao_dourada_2_class_unbalanced.csv',False)
executar('experimento/e3/','experimento/sce/unbalanced/colecao_dourada_3_class_unbalanced.csv',False)
executar('experimento/e3/','experimento/sce/balanced/colecao_dourada_2_class_balanced.csv',False)
executar('experimento/e3/','experimento/sce/balanced/colecao_dourada_3_class_balanced.csv',False)
executar('experimento/e4/','experimento/sce/unbalanced/colecao_dourada_2_class_unbalanced.csv',True)
executar('experimento/e4/','experimento/sce/unbalanced/colecao_dourada_3_class_unbalanced.csv',True)
executar('experimento/e4/','experimento/sce/balanced/colecao_dourada_2_class_balanced.csv',True)
executar('experimento/e4/','experimento/sce/balanced/colecao_dourada_3_class_balanced.csv',True)